...
import { IconButton,AddShoppingCartIcon } from '@material-ui/core';
import { useState, useEffect } from 'react'
import { useCollectionData } from 'react-firebase-hooks/firestore'

//react bootstrap
import { FormText,  Modal, Container, Row, Col } from 'react-bootstrap';
...
import {Paper, Typography , TextField, TableContainer, TableHead, TableRow,TableBody,Table} from '@material-ui/core';
            ...
            <Container>
                        ...
                        <Table aria-label="customized table" >
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell aligh="right"> </StyledTableCell>
                                    <StyledTableCell aligh="right"> </StyledTableCell>
                                </TableRow>
                            </TableHead>
                            <tbody>
                ...
                <Modal
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Modal.Footer>
                            <Button variant="outlined" onClick={handleCloseForm} style={{marginRight: 3+'%'}}>
                                Close
                            </Button>
                ...
                <footer>
                    ...
                    <div style={{ display: "flex" }}>
                        ...
                        <Button variant="contained" color="secondary" onClick={handleshowForm} style={{marginLeft: "auto", marginTop: 5+'%'}}>
                            ADD
                        </Button>
                    </div>
...
function CategoryTableRow(props) {
    ...
    return (
        <StyledTableRow >
            ...
            <StyledTableCell aligh="right" onClick={() => props.onDeleteClicked(id,list)}>
                <DeleteForeverIcon />

            </StyledTableCell>
            <StyledTableCell  onClick={() => props.onEditClick(id,list)}>
                <EditIcon />
            </StyledTableCell>
        </StyledTableRow>        
    )
